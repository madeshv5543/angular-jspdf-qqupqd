...
<!-- Do NOT edit this HTML directly: it was generated via an XSLT transformation from a CDA Release 2 or 3 XML document. -->
<!DOCTYPE html
  PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
   <head>
      <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
      <title>Summarization Of Episode (May 21, 2019, 03:09AM -0400)</title>
      <!-- General CSS -->
      <style type="text/css" media="all">
                    *{
                    ...
                    span {
                        font-size: 9pt; /* IE8 hack: doesn't understand inheritance */
      ...
      <!-- Javascript for Revisions switch -->
      <script type="text/javascript">var gStringCollapse = "Collapse"; var gStringExpand = "Expand";
      ...
      <!-- Javascript for Table of Contents menu -->
   ...
   <body>
      <div id="documentheader">
         <a id="_toc"> </a>
         <h1 class="title">Summarization Of Episode (May 21, 2019, 03:09AM -0400)</h1>
         <table class="header_table">
            <tbody>
               <tr>
                  <td class="td_label">recordTarget</td>
                  <td>
                     <span class="span_value">ROCHESTER  Steve</span>
                     <span style="float: right; margin-left: 1em;">
                        <span>
                           <span class="span_label">birthTimeLong: </span>
                           <span class="span_value">November  5, 1995, 00AM -0500<span title="At document creation time"> (23yr)</span>
                           </span>
                        </span>
                        <span class="span_label">administrativeGenderCode: </span>
                        <span class="span_value">M</span>
                     </span>
                     <span style="float: right;" class="print_visible">
                        <span class="span_label">patientIdLong: </span>
                        <span class="span_value">
                           <span>1517509003 (2.16.840.1.113883.3.458.10.3.1)</span>
                        </span>
                     </span>
                  </td>
               </tr>
               <tr>
                  <td class="td_label">documentationOf</td>
                  <td>2.16.840.1.113883.5.6-PCPR, <span class="span_label">effectiveTime: </span>
                     <span class="span_value">from March  5, 2013, 08:48:39AM -0500 to August  11, 2013, 2:55PM -0400</span>, <span class="span_label">typeCode-PRF: </span>
                     <span class="span_value">BANSAL  VIJAY  K MD</span>, <span class="span_label">typeCode-PRF: </span>
                     <span class="span_value">FOX  KELITA  L</span>, <span class="span_label">typeCode-PRF: </span>
                     <span class="span_value">MITTEREDER  RICHARD  F</span>
                  </td>
               </tr>
               <tr>
                  <td class="td_label">author</td>
                  <td>
                     <span class="span_value">nullFlavor_NA</span>, <span class="span_label">organization: </span>
                     <span class="span_value">Rochester RHIO STAGE</span>, <span class="span_label">Authored_on: </span>
                     <span class="span_value">May  21, 2019, 03:09AM -0400</span>
                  </td>
               </tr>
            </tbody>
         </table>
               ...
               <tbody>
                  <tr>
                     <td style="width: 35%; background-color: white;">
                        <ul id="nav">
                           <li style="list-style: none;">
                              <div class="span_button">Table of Contents ∇</div>
                              <ul>
                                 <li>
                                    <a href="#section_1">Re-disclosure Warning</a>
                                 </li>
                                 <li>
                                    <a href="#section_2">Encounters</a>
                                 </li>
                                 <li>
                                    <a href="#section_3">Insurance Providers</a>
                                 </li>
                                 <li>
                                    <a href="#section_4">Results</a>
                                 </li>
                              </ul>
                           </li>
                        </ul>
                     ...
                     <td style="background-color: white;">
                        <div id="sectionsToggleExpand"
                             style="display: none;"
                             class="span_button"
                             onclick="expandAllSections();">Expand All</div>
                        <div id="sectionsToggleCollapse"
                             class="span_button"
                             onclick="collapseAllSections();">Collapse All</div>
                     </td>
                  </tr>
               </tbody>
            </table>
      ...
      <div id="documentbody">
         <div style="margin-left: 0em;" class="section">
            <div class="section-title">
               <div class="button expandCollapse"
                    onclick="collapseSection(this)"
                    title="Collapse">▼</div>
               <h3 id="section_1">Re-disclosure Warning</h3>
            </div>
            <div class="section-content">
               <div class="section-body">
                  <div>The records that you are about to access may contain information from federally-assisted alcohol or drug abuse programs. If such information is present, then the following federally mandated warning applies: This information has been disclosed to you from records protected by Federal confidentiality rules (42 CFR part 2). The Federal rules prohibit you from making any further disclosure of this information unless further disclosure is expressly permitted by the written consent of the person to whom it pertains or as otherwise permitted by 42 CFR part 2. A general authorization for the release of medical or other information is NOT sufficient for this purpose. The Federal rules restrict any use of the information to criminally investigate or prosecute any alcohol or drug abuse patient.

The records that you are about to access may contain HIV/AIDS INFORMATION, which is protected under the Article 27-F of the NY Public Health Law. Re-disclosure of this information is subject NY State and other laws and regulations, with which you must comply.

The records that you are about to access may contain information from facilities licensed or operated by the New York State Office of Mental Health or the New York State Office for People With Developmental Disabilities. Re-disclosure of this information is subject NY State Mental Hygiene Section 33.13 and other laws and regulations, with which you must comply.

The records that you are about to access may contain genetic information (including information containing results from genetic testing, genetic profiling, genetic counseling and information pertaining to the family medical history of a patient) that is subject to confidentiality restrictions under the Genetic Information Non-Discrimination Act of 2008 and implementing regulations. Re-disclosure of this information to employers and payers may be limited or prohibited.</div>
               </div>
            </div>
         </div>
         <div style="margin-left: 0em;" class="section">
            <div class="section-title">
               <div class="button expandCollapse"
                    onclick="collapseSection(this)"
                    title="Collapse">▼</div>
               <h3 id="section_2" title="History of encounters">Encounters</h3>
            </div>
            <div class="section-content">
               <div class="section-body">
                  <div>
                     <table class="narr_table"
                        ...
                        <thead>
                           <tr class="narr_tr">
                              <th class="narr_th">Encounter</th>
                              <th class="narr_th">Providers</th>
                              <th class="narr_th">Location</th>
                              <th class="narr_th">Date</th>
                              <th class="narr_th">Indications</th>
                              <th class="narr_th">Data Source(s)</th>
                           </tr>
                        </thead>
                        <tbody>
                           <tr class="narr_tr">
                              <td>
                                 <span id="Encounter-encounter-1">I</span>
                              </td>
                              <td>
                                 <span>Attender: VIJAY BANSAL MD
Admitter: VIJAY BANSAL MD</span>
                              </td>
                              <td>
                                 <span>EDM-EDM</span>
                              </td>
                              <td>
                                 <span>08/11/2013 02:55:00 PM EDT</span>
                              </td>
                              <td/>
                              <td>
                                 <span>FF Thompson Hospital</span>
                              </td>
                           </tr>
                           <tr class="narr_tr">
                              <td>
                                 <span id="Encounter-encounter-2">O</span>
                              </td>
                              <td/>
                              <td>
                                 <span>6-6</span>
                              ...
                              <td>
                                 <span>03/05/2013 08:48:39 AM EST</span>
                              </td>
                              <td/>
                              <td>
                                 <span>eHT Testing Facility</span>
                              </td>
                           </tr>
                        </tbody>
                     </table>
         ...
         <div style="margin-left: 0em;" class="section">
            <div class="section-title">
               <div class="button expandCollapse"
                    onclick="collapseSection(this)"
                    title="Collapse">▼</div>
               <h3 id="section_3" title="Payment sources">Insurance Providers</h3>
            </div>
            <div class="section-content">
               <div class="section-body">
                  <div>
                     <table class="narr_table"
                        ...
                        <thead>
                           <tr class="narr_tr">
                              <th class="narr_th">Payer name</th>
                              <th class="narr_th">Policy type / Coverage type</th>
                              <th class="narr_th">Policy ID</th>
                              <th class="narr_th">Covered party ID</th>
                              <th class="narr_th">Covered party's relationship to holder</th>
                              <th class="narr_th">Policy Holder</th>
                              <th class="narr_th">Plan Information</th>
                           </tr>
                        </thead>
                        <tbody>
                           <tr class="narr_tr">
                              ...
                              <td/>
                              <td>
                                 <span id="Plan-Name-payer-1">A</span>
                              </td>
                           </tr>
                           <tr class="narr_tr">
                              <td>
                              ...
                              <td>
                                 <span>PREFERRED CARE GOLD</span>
                              </td>
                              <td>
                                 <span>A0055555555</span>
                              </td>
                              <td/>
                              <td>
                                 <span>01</span>
                              ...
                              <td/>
                              <td>
                                 <span id="Plan-Name-payer-2">A0055555555</span>
                              </td>
                           </tr>
                           <tr class="narr_tr">
                              <td>
                              ...
                              <td/>
                              <td>
                                 <span id="Plan-Name-payer-3">A</span>
                              </td>
                           </tr>
                           <tr class="narr_tr">
                              <td>
                              ...
                              <td/>
                              <td>
                                 <span id="Plan-Name-payer-4">A0055555555</span>
                              </td>
                           </tr>
                        </tbody>
                     </table>
         ...
         <div style="margin-left: 0em;" class="section">
            <div class="section-title">
               <div class="button expandCollapse"
                    onclick="collapseSection(this)"
                    title="Collapse">▼</div>
               <h3 id="section_4" title="STUDIES SUMMARY">Results</h3>
            </div>
            <div class="section-content">
               <div class="section-body">
                  <div>
                     <table class="narr_table"
                        ...
                        <thead>
                           <tr class="narr_tr">
                              <th class="narr_th">ID</th>
                              <th class="narr_th">Date</th>
                              <th class="narr_th">Data Source</th>
                           </tr>
                        </thead>
                        <tbody>
                           <tr class="narr_tr">
                              <td>321368200</td>
                              <td>09/14/2013 03:46:00 PM EDT</td>
                              <td>eHT Testing Facility</td>
                           </tr>
                        </tbody>
                     </table>
                     <br/>
                     <table class="narr_table"
                        ...
                        <thead>
                           <tr class="narr_tr">
                              <th class="narr_th">Name</th>
                              <th class="narr_th">Value</th>
                              <th class="narr_th">Range</th>
                              <th class="narr_th">Interpretation Code</th>
                              <th class="narr_th">Description</th>
                              <th class="narr_th">Data Source(s)</th>
                              <th class="narr_th">Supporting Document(s)</th>
                           </tr>
                        </thead>
                        <tbody>
                           <tr class="narr_tr">
                              <th class="narr_th">CT ABDOMEN PELVIS W CONTRAST</th>
                              <td>
                                 <span/>
                              </td>
                              <td/>
                              <td/>
                              <td id="result-description-results-1-1"/>
                              <td>eHT Testing Facility</td>
                              <td/>
                           </tr>
                        </tbody>
                     ...
                     <table class="narr_table"
                        ...
                        <tbody>
                           <tr class="narr_tr">
                              <td>88888888888</td>
                              <td>08/11/2013 05:08:00 PM EDT</td>
                              <td>FF Thompson Hospital</td>
                           </tr>
                        </tbody>
                     </table>
                     <br/>
                     <table class="narr_table"
                        ...
                        <tbody>
                           <tr class="narr_tr">
                              <th class="narr_th">INR</th>
                              <td>
                                 <span>1.08 </span>
                              </td>
                              <td>0.90-1.17</td>
                              <td>N</td>
                              <td id="result-description-results-3-1"/>
                              <td>FF Thompson Hospital</td>
                              <td/>
                           </tr>
                           <tr class="narr_tr">
                              <td colspan="100%" id="result-organizer-results-3-observation-1-notes">RECOMMENDED THERAPEUTIC RANGE FOR ORAL
ANTICOAGULANT THERAPY

Prophylaxis/treatment of:         INR range
Venous thrombosis         2.0-3.0
Pulmonary Embolism         2.0-3.0

Prevention of systemic embolism from:
Atrial Fibrilation         2.0-3.0
...
Recurrent Systemic Embolism         2.5-3.5
                     ...
                     <table class="narr_table"
                        ...
                        <tbody>
                           <tr class="narr_tr">
                              <td>00088888888</td>
                              <td>08/11/2013 04:33:00 PM EDT</td>
                              <td>FF Thompson Hospital</td>
                           </tr>
                        </tbody>
                     </table>
                     ...
                     <table class="narr_table"
                        ...
                        <tbody>
                           <tr class="narr_tr">
                              <th class="narr_th">Sodium</th>
                              <td>
                                 <span>138 meq/L</span>
                              </td>
                              <td>136-145</td>
                              <td>N</td>
                              <td id="result-description-results-5-1"/>
                              <td>FF Thompson Hospital</td>
                              <td/>
                           </tr>
                           <tr class="narr_tr">
                              <th class="narr_th">Potassium</th>
                              <td>
                                 <span>3.1 meq/L</span>
                              </td>
                              <td>3.5-5.1</td>
                              <td>L</td>
                              <td id="result-description-results-5-2"/>
                              <td>FF Thompson Hospital</td>
                              <td/>
                           </tr>
                           <tr class="narr_tr">
                              <th class="narr_th">Chloride</th>
                              <td>
                                 <span>102 meq/L</span>
                              </td>
                              <td>98-107</td>
                              <td>N</td>
                              <td id="result-description-results-5-3"/>
                              <td>FF Thompson Hospital</td>
                              <td/>
                           </tr>
                           <tr class="narr_tr">
                              <th class="narr_th">CO2</th>
                              <td>
                                 <span>22 meq/L</span>
                              </td>
                              <td>21-32</td>
                              <td>N</td>
                              <td id="result-description-results-5-4"/>
                              <td>FF Thompson Hospital</td>
                              <td/>
                           </tr>
                           <tr class="narr_tr">
                              <th class="narr_th">Anion Gap</th>
                              <td>
                                 <span>14 </span>
                              </td>
                              <td>3-11</td>
                              <td>H</td>
                              <td id="result-description-results-5-5"/>
                              <td>FF Thompson Hospital</td>
                              <td/>
                           </tr>
                           <tr class="narr_tr">
                              <th class="narr_th">BUN</th>
                              <td>
                                 <span>8 mg/dL</span>
                              </td>
                              <td>7-18</td>
                              <td>N</td>
                              <td id="result-description-results-5-6"/>
                              <td>FF Thompson Hospital</td>
                              <td/>
                           </tr>
                           <tr class="narr_tr">
                              <th class="narr_th">Glucose</th>
                              <td>
                                 <span>134 mg/dL</span>
                              </td>
                              <td>70-100</td>
                              <td>H</td>
                              <td id="result-description-results-5-7"/>
                              <td>FF Thompson Hospital</td>
                              <td/>
                           </tr>
                           <tr class="narr_tr">
                              <th class="narr_th">Creatinine</th>
                              <td>
                                 <span>0.9 mg/dL</span>
                              </td>
                              <td>0.6-1.3</td>
                              <td>N</td>
                              <td id="result-description-results-5-8"/>
                              <td>FF Thompson Hospital</td>
                              <td/>
                           </tr>
                           <tr class="narr_tr">
                              <th class="narr_th">E-GFR: non Afr-Am</th>
                              <td>
                                 <span>67 mL/min/1.73m2</span>
                              </td>
                              <td/>
                              <td/>
                              <td id="result-description-results-5-9"/>
                              <td>FF Thompson Hospital</td>
                              <td/>
                           </tr>
                           <tr class="narr_tr">
                              <td colspan="100%" id="result-organizer-results-5-observation-9-notes">e-GFR Interpretive Statement:
Normal kidney function         &gt;60 mL/min/1.73m2
Decreased kidney function         15-60 mL/min/1.73m2
Kidney failure         &lt;15 mL/min/1.73m2
                           ...
                           <tr class="narr_tr">
                              <th class="narr_th">E-GFR: Afro-Am</th>
                              <td>
                                 <span>81 mL/min/1.73m2</span>
                              </td>
                              <td/>
                              <td/>
                              <td id="result-description-results-5-10"/>
                              <td>FF Thompson Hospital</td>
                              <td/>
                           </tr>
                           <tr class="narr_tr">
                              <td colspan="100%" id="result-organizer-results-5-observation-10-notes">e-GFR Interpretive Statement:
Normal kidney function         &gt;60 mL/min/1.73m2
Decreased kidney function         15-60 mL/min/1.73m2
Kidney failure         &lt;15 mL/min/1.73m2
                           ...
                           <tr class="narr_tr">
                              <th class="narr_th">Calcium</th>
                              <td>
                                 <span>8.6 mg/dL</span>
                              </td>
                              <td>8.5-10.1</td>
                              <td>N</td>
                              <td id="result-description-results-5-11"/>
                              <td>FF Thompson Hospital</td>
                              <td/>
                           </tr>
                           <tr class="narr_tr">
                              <th class="narr_th">Total Protein</th>
                              <td>
                                 <span>7.7 g/dL</span>
                              </td>
                              <td>6.4-8.2</td>
                              <td>N</td>
                              <td id="result-description-results-5-12"/>
                              <td>FF Thompson Hospital</td>
                              <td/>
                           </tr>
                           <tr class="narr_tr">
                              <th class="narr_th">Albumin</th>
                              <td>
                                 <span>3.7 g/dL</span>
                              </td>
                              <td>3.4-5.0</td>
                              <td>N</td>
                              <td id="result-description-results-5-13"/>
                              <td>FF Thompson Hospital</td>
                              <td/>
                           </tr>
                           <tr class="narr_tr">
                              <th class="narr_th">Total Bilirubin</th>
                              <td>
                                 <span>2.4 mg/dL</span>
                              </td>
                              <td>0.2-1.0</td>
                              <td>H</td>
                              <td id="result-description-results-5-14"/>
                              <td>FF Thompson Hospital</td>
                              <td/>
                           </tr>
                           <tr class="narr_tr">
                              <th class="narr_th">Alk Phos</th>
                              <td>
                                 <span>181 U/L</span>
                              </td>
                              <td>50-136</td>
                              <td>H</td>
                              <td id="result-description-results-5-15"/>
                              <td>FF Thompson Hospital</td>
                              <td/>
                           </tr>
                           <tr class="narr_tr">
                              <th class="narr_th">AST/SGOT</th>
                              <td>
                                 <span>276 U/L</span>
                              </td>
                              <td>11-37</td>
                              <td>H</td>
                              <td id="result-description-results-5-16"/>
                              <td>FF Thompson Hospital</td>
                              <td/>
                           </tr>
                           <tr class="narr_tr">
                              <th class="narr_th">ALT/SGPT</th>
                              <td>
                                 <span>62 U/L</span>
                              </td>
                              <td>12-78</td>
                              <td>N</td>
                              <td id="result-description-results-5-17"/>
                              <td>FF Thompson Hospital</td>
                              <td/>
                           </tr>
                        </tbody>
                     ...
                     <table class="narr_table"
                        ...
                        <tbody>
                           <tr class="narr_tr">
                              <th class="narr_th">Lipase</th>
                              <td>
                                 <span>163 U/L</span>
                              </td>
                              <td>73-393</td>
                              <td>N</td>
                              <td id="result-description-results-6-1"/>
                              <td>FF Thompson Hospital</td>
                              <td/>
                           </tr>
                        </tbody>
                     ...
                     <table class="narr_table"
                        ...
                        <tbody>
                           <tr class="narr_tr">
                              <td>86789558</td>
                              <td>06/03/2013 03:37:00 PM EDT</td>
                              <td>ACM Medical Laboratory</td>
                           </tr>
                        </tbody>
                     </table>
                     <br/>
                     <table class="narr_table"
                        ...
                        <tbody>
                           <tr class="narr_tr">
                              <th class="narr_th">25-HYDROXY VITAMIN D</th>
                              <td>
                                 <span>35 ng/mL</span>
                              </td>
                              <td>30-100</td>
                              <td/>
                              <td id="result-description-results-8-1"/>
                              <td>ACM Medical Laboratory</td>
                              <td/>
                           </tr>
                           <tr class="narr_tr">
                              <td colspan="100%" id="result-organizer-results-8-observation-1-notes">Interpretation:
20-29 ng/mL    Suggestive of Vitamin D insufficiency
&lt;20 ng/mL      Suggestive of Vitamin D deficiency
</td>
                           </tr>
                        </tbody>
                     </table>
                     ...
                     <table class="narr_table"
                        ...
                        <tbody>
                           <tr class="narr_tr">
                              <td>82330812</td>
                              <td>05/03/2013 09:18:00 AM EDT</td>
                              <td>ACM Medical Laboratory</td>
                           </tr>
                        </tbody>
                     </table>
                     ...
                     <table class="narr_table"
                        ...
                        <tbody>
                           <tr class="narr_tr">
                              ...
                              <td>60-140</td>
                              <td/>
                              <td id="result-description-results-10-1"/>
                              <td>ACM Medical Laboratory</td>
                              <td/>
                           </tr>
                           <tr class="narr_tr">
                              <td colspan="100%" id="result-organizer-results-10-observation-1-notes">NOTE: Random Glucose range 60-140 mg/dl
Fasting Glucose range 60-99 mg/dl
.
</td>
                           </tr>
                           <tr class="narr_tr">
                              ...
                              <td>9-23</td>
                              <td>H</td>
                              <td id="result-description-results-10-2"/>
                              <td>ACM Medical Laboratory</td>
                              <td/>
                           </tr>
                           <tr class="narr_tr">
                              <th class="narr_th">CREATININE</th>
                              <td>
                                 <span>1.38 mg/dL</span>
                              </td>
                              <td>0.70-1.30</td>
                              <td>H</td>
                              <td id="result-description-results-10-3"/>
                              <td>ACM Medical Laboratory</td>
                              <td/>
                           </tr>
                           <tr class="narr_tr">
                              <th class="narr_th">BUN/CREATININE RATIO</th>
                              <td>
                                 <span>24 </span>
                              </td>
                              <td>10-20</td>
                              <td>H</td>
                              <td id="result-description-results-10-4"/>
                              <td>ACM Medical Laboratory</td>
                              <td/>
                           </tr>
                           <tr class="narr_tr">
                              <th class="narr_th">SODIUM</th>
                              <td>
                                 <span>141 mmol/L</span>
                              </td>
                              <td>136-145</td>
                              <td/>
                              <td id="result-description-results-10-5"/>
                              <td>ACM Medical Laboratory</td>
                              <td/>
                           </tr>
                           <tr class="narr_tr">
                              <th class="narr_th">POTASSIUM</th>
                              <td>
                                 <span>5.0 mmol/L</span>
                              </td>
                              <td>3.5-5.1</td>
                              <td/>
                              <td id="result-description-results-10-6"/>
                              <td>ACM Medical Laboratory</td>
                              <td/>
                           </tr>
                           <tr class="narr_tr">
                              <th class="narr_th">CHLORIDE</th>
                              <td>
                                 <span>111 mmol/L</span>
                              </td>
                              <td>99-109</td>
                              <td>H</td>
                              <td id="result-description-results-10-7"/>
                              <td>ACM Medical Laboratory</td>
                              <td/>
                           </tr>
                           <tr class="narr_tr">
                              <th class="narr_th">CARBON DIOXIDE</th>
                              <td>
                                 <span>25 mmol/L</span>
                              </td>
                              <td>20-31</td>
                              <td/>
                              <td id="result-description-results-10-8"/>
                              <td>ACM Medical Laboratory</td>
                              <td/>
                           </tr>
                           <tr class="narr_tr">
                              ...
                              <td>8.6-10.2</td>
                              <td>L</td>
                              <td id="result-description-results-10-9"/>
                              <td>ACM Medical Laboratory</td>
                              <td/>
                           </tr>
                        </tbody>
                     ...
                     <table class="narr_table"
                        ...
                        <tbody>
                           <tr class="narr_tr">
                              <td>7777789</td>
                              <td>03/06/2013 10:29:00 AM EST</td>
                              <td>eHT Testing Facility</td>
                           </tr>
                        </tbody>
                     </table>
                     ...
                     <table class="narr_table"
                        ...
                        <tbody>
                           <tr class="narr_tr">
                              <th class="narr_th">TEXT DIAGNOSIS BATTERY</th>
                              <td>
                                 <span/>
                              </td>
                              <td/>
                              <td/>
                              <td id="result-description-results-12-1"/>
                              <td>eHT Testing Facility</td>
                              <td/>
                           </tr>
                        </tbody>
                     ...
                     <table class="narr_table"
                        ...
                        <tbody>
                           <tr class="narr_tr">
                              <td>16667890</td>
                              <td>03/05/2013 08:48:39 AM EST</td>
                              <td>eHT Testing Facility</td>
                           </tr>
                        </tbody>
                     </table>
                     ...
                     <table class="narr_table"
                        ...
                        <tbody>
                           <tr class="narr_tr">
                              ...
                              <td/>
                              <td/>
                              <td id="result-description-results-14-1"/>
                              <td>eHT Testing Facility</td>
                              <td/>
                           </tr>
                        </tbody>
                     ...
                     <table class="narr_table"
                        ...
                        <thead>
                           <tr class="narr_tr">
                              <th class="narr_th">Procedure</th>
                           </tr>
                        </thead>
                        <tbody>
                           <tr class="narr_tr">
                              <td colspan="100%" id="lab-procedure-for-validator"/>
                           </tr>
                        </tbody>
                     </table>
                  </div>
      ...
      <div id="documentfooter">
         <table class="header_table">
            <tbody>
               <tr>
                  <td class="td_label td_label_width">Document</td>
                  <td style="width: 30%;">
                     <table class="table_simple">
                        <tbody>
                           <tr>
                              ...
                              <td>
                                 <span>kIVLpVGinlnw2YFi (2.16.840.1.113883.3.458.10.3.1)</span>
                              </td>
                           </tr>
                           <tr>
                              <td class="td_label">versionNumber</td>
                              <td/>
                           </tr>
                           <tr>
                              <td class="td_label">setId</td>
                              <td>
                                 <span>(nullFlavor_NA)</span>
                              </td>
                           </tr>
                        </tbody>
                     </table>
                  </td>
                  <td class="td_label td_label_width">Created_on</td>
                  <td>May  21, 2019, 03:09AM -0400</td>
               </tr>
            </tbody>
         </table>
         <table class="header_table">
            <tbody>
               <tr>
                  <td class="td_label td_label_width">custodian</td>
                  <td style="width: 30%;">Rochester RHIO STAGE</td>
                  <td class="td_label td_label_width">Contact_details</td>
                  <td>nullFlavor_UNK<br/>
                  </td>
               </tr>
            </tbody>
         </table>
         ...
         <table class="header_table">
            <tbody>
               <tr>
                  <td class="td_label td_label_width">recordTarget</td>
                  <td style="width: 30%;">ROCHESTER  Steve</td>
                  <td class="td_label td_label_width">Contact_details</td>
                  <td style="width: 30%;">3243 DEVANSE STREET<br/>DEVANSE STREET<br/>undefined, NY 30013<br/>
                     <br/>Tel addressUse_HP: 1111111111, Tel addressUse_WP: 000-0000000</td>
               </tr>
               <tr>
                  <td class="td_label td_label_width">birthTimeLong</td>
                  <td style="width: 30%;">November  5, 1995, 00AM -0500 (23yr)</td>
                  <td class="td_label td_label_width">administrativeGenderCode</td>
                  <td>M</td>
               </tr>
               <tr>
                  <td class="td_label td_label_width">Race</td>
                  <td style="width: 30%;">nullFlavor_UNK</td>
                  <td class="td_label td_label_width">Ethnicity</td>
                  <td>nullFlavor_UNK</td>
               </tr>
               <tr>
                  <td class="td_label td_label_width">patientIdsLong</td>
                  <td>
                     <span>1517509003 (2.16.840.1.113883.3.458.10.3.1)</span>
                  </td>
                  <td class="td_label td_label_width">languageCommunication</td>
                  <td colspan="3">
                     <div>F, preferredLanguage: boolean-false</div>
                     <div>A, preferredLanguage: boolean-false</div>
                  </td>
               </tr>
            </tbody>
         </table>
         ...
         <table class="header_table">
            <tbody>
               <tr>
                  <td class="td_label td_label_width">documentationOf - 2.16.840.1.113883.5.6-PCPR</td>
                  <td style="width: 80%;" colspan="3">from March  5, 2013, 08:48:39AM -0500 to August  11, 2013, 2:55PM -0400</td>
               </tr>
               <tr>
                  <td class="td_label td_label_width">2.16.840.1.113883.5.90-PRF - </td>
                  <td style="width: 30%;">BANSAL  VIJAY  K MD of FF Thompson Hospital</td>
                  <td class="td_label td_label_width">Contact_details</td>
                  <td>nullFlavor_UNK<br/>
                  </td>
               </tr>
               <tr>
                  <td class="td_label td_label_width">2.16.840.1.113883.5.90-PRF - Primary Care Provider</td>
                  <td style="width: 30%;">FOX  KELITA  L of Strong Memorial Hospital</td>
                  <td class="td_label td_label_width">Contact_details</td>
                  <td>nullFlavor_UNK<br/>
                  </td>
               </tr>
               <tr>
                  <td class="td_label td_label_width">2.16.840.1.113883.5.90-PRF - Primary Care Provider</td>
                  <td style="width: 30%;">MITTEREDER  RICHARD  F of Unity Health System</td>
                  <td class="td_label td_label_width">Contact_details</td>
                  <td>nullFlavor_UNK<br/>
                  </td>
               </tr>
         ...
         <table class="header_table">
            <tbody>
               <tr>
                  <td class="td_label td_label_width" rowspan="2">author</td>
                  <td style="width: 30%;" rowspan="2">nullFlavor_NA, organization: Rochester RHIO STAGE</td>
                  <td class="td_label td_label_width">Contact_details</td>
                  <td>nullFlavor_UNK<br/>
                  </td>
               </tr>
               <tr>
                  <td class="td_label td_label_width">Contact_details (organization)</td>
                  <td>nullFlavor_UNK<br/>
                  </td>
               </tr>
            </tbody>
         ...
         <table class="header_table">
            <tbody>
               <tr>
                  <td class="td_label td_label_width">2.16.840.1.113883.5.90-IND - 2.16.840.1.113883.5.110-NOK</td>
                  <td style="width: 30%;">STROBEL  TERRY</td>
                  <td class="td_label td_label_width">Contact_details</td>
                  <td>nullFlavor_UNK<br/>
                  </td>
               </tr>
         ...
         <table class="header_table">
            <tbody>
               <tr>
                  <td class="td_label td_label_width">2.16.840.1.113883.5.90-IND - 2.16.840.1.113883.5.110-NOK 04</td>
                  <td style="width: 30%;">ROCHESTER  SPOUSE, 04</td>
                  <td class="td_label td_label_width">Contact_details</td>
                  <td>777 Once Upon a Time Lane<br/>Rochester, NY, 14609 US<br/>
                     <br/>
                  </td>
               </tr>
            </tbody>
         ...
         <table class="header_table">
            <tbody>
               <tr>
                  <td class="td_label td_label_width">typeCode-ENT</td>
                  <td style="width: 30%;">nullFlavor_NA of Rochester RHIO STAGE</td>
                  <td class="td_label td_label_width">Contact_details</td>
                  <td>nullFlavor_UNK<br/>
                  </td>
               </tr>
